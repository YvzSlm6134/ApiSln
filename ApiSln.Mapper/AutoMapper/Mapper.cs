...
{
    public class Mapper : Application.İnterfaces.AutoMapper.IMapper
    {
        ...
        {
            Config<TDestination, TSource>(8, ignore);
        ...
        {
            Config<TDestination, object>(8, ignore);
        ...
        {
            Config<TDestination, IList<object>>(8, ignore);
